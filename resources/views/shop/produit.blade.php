...
<nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{route('voir_produits_par_cat',['id'=>$produit->category->parent->id])}}">{{$produit->category->nom}}</a></li>
            @endif
    ...
    <div class="album py-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{ asset('produits/image9.jpg')}}" class="card-img-top img-fluid" alt="Responsive image">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{ asset('produits/image3.jpg')}}" class="card-img-top img-fluid" alt="Responsive image">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{ asset('produits/image4.jpg')}}" class="card-img-top img-fluid" alt="Responsive image">
